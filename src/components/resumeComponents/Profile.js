...
const Profile = props => {
    ...
    return  <div>
                  ...
                  <div className="divider"></div>
                  <p>I built this page with <a href="https://facebook.github.io/react/">React</a> components and a <a href="https://jsonresume.org/schema/">JSON Resume Schema</a>. The full source code can be found in <a href="https://github.com/Suryanarayanamurthy">my Github repo</a>.</p>
            </div>
};
